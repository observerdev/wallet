...
(function () {
	...
	coinjs.pub = 0x73;
	coinjs.priv = 0xde;
	coinjs.multisig = 0x13;
	coinjs.hdkey = {'prv':0x0221271a, 'pub':0x022e321b};
	coinjs.bech32 = {'charset':'qpzry9x8gf2tvdw0s3jn54khce6mua7l', 'version':0, 'hrp':'bc'};

	coinjs.compressed = false;

	/* other vars */
	coinjs.developer = '14XDgvXFMKKfskXYBZSk4eWYWfZ8XYL87f'; //bitcoin

	/* bit(coinb.in) api vars */
	coinjs.host = ('https:'==document.location.protocol?'https://':'http://')+'https://explorer.obsr.org/#/api/';
	coinjs.uid = '1';
